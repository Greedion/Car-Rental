...
public class RentalController {
    ...
    public ResponseEntity<HttpStatus> rentalAttempt(@RequestBody @Valid Loan loan, HttpServletRequest httpServletRequest) {
        ...
        if (username == null) {
            logger.error(ExceptionsMessageArchive.RENTAL_C_NULL_USERNAME_EXCEPTION);
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, ExceptionsMessageArchive.RENTAL_C_NULL_USERNAME_EXCEPTION);
        }
