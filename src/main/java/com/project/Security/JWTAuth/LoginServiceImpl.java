...
public class LoginServiceImpl implements LoginService{
    ...
    private final static String REFRESH_TOKEN_EXCEPTION = "Wrong refresh token Structure or Token Expired";
    ...
    @Override
    public ResponseEntity<?> refreshSession(String refreshToken, String inputUsername) throws ServletException {
    ...
    @Override
    public ResponseEntity<?> start(POJOUser pojoUser) {
